...
import { Mic, Eye, EyeOff, ArrowRight, Loader2, CheckCircle2 } from "lucide-react";
      ...
      <div className="hidden lg:flex w-[45%] relative overflow-hidden items-center justify-center flex-col">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-12">
          ...
          <p className="text-white/35 text-sm leading-relaxed max-w-xs mb-8">
            Set up your co-pilot in 60 seconds and start commanding the web by voice today.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative">
        ...
        >
          <div className="mb-7">
            ...
            <p className="text-white/35 text-sm">Your AI co-pilot is ready to activate</p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-[11px] text-white/22 font-medium">or register with email</span>
            <div className="flex-1 h-px bg-white/[0.07]" />
          </div>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="name" className="text-white/50 text-[11px] font-semibold uppercase tracking-wider">Full name</Label>
              <Input id="name" name="name" type="text" placeholder="Alex Johnson" autoComplete="name"
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="confirmPassword" className="text-white/50 text-[11px] font-semibold uppercase tracking-wider">Confirm password</Label>
              <div className="relative">
                <Input id="confirmPassword" name="confirmPassword" type={showConfirm ? "text" : "password"} placeholder="Repeat your password"
          ...
          <p className="text-center mt-6 text-sm text-white/28">
            Have an account?{" "}
            <Link href="/sign-in" className="text-primary hover:text-primary/70 font-semibold transition-colors" data-testid="link-sign-in">
              Sign in
            </Link>
          </p>
        </motion.div>
