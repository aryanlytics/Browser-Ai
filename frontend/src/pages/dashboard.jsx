...
import {
  Mic, MicOff, Monitor, MonitorOff, LogOut, Clock, Globe, Search,
  Mail, User, Settings, ChevronRight, Zap, Loader2
} from "lucide-react";
...
const MOCK_TASKS: TaskEntry[] = [
  ...
  { id: "3", type: "email", label: "Drafted reply to client proposal", time: "24 min ago", status: "done" },
  { id: "4", type: "browse", label: "Opened GitHub repository for Next.js", time: "1 hr ago", status: "done" },
];
    ...
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-4 border-b border-white/5 backdrop-blur-md bg-background/50">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-lg text-white tracking-tight">BrowseAI</span>
      ...
      <div className="relative z-10 flex flex-1 overflow-hidden">
        ...
        <aside className="hidden lg:flex w-72 border-r border-white/5 flex-col p-4 gap-4 bg-background/30 backdrop-blur-sm">
          ...
          <div className="glass-panel rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              <span className="text-xs font-semibold uppercase tracking-widest text-white/40">Browser Access</span>
            </div>
            <button
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs opacity-60">
                  {screenSharing ? "Agent can see your browser" : "Let the agent navigate for you"}
                </p>
              </div>
            </button>
          </div>
          ...
          <div className="glass-panel rounded-xl p-4 flex-1 overflow-hidden flex flex-col">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xs font-semibold uppercase tracking-widest text-white/40">Recent Tasks</span>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs text-white/80 leading-snug truncate group-hover:text-white transition-colors">{task.label}</p>
                      <p className="text-xs text-white/30 mt-0.5">{task.time}</p>
                    </div>
          ...
          {/* Quick actions */}
          <div className="glass-panel rounded-xl p-4">
            <p className="text-xs font-semibold uppercase tracking-widest text-white/40 mb-3">Quick commands</p>
            <div className="flex flex-col gap-1.5">
              {["Search YouTube for...", "Write an email to...", "Research topic..."].map((cmd, i) => (
                <button
                  key={i}
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-6 gap-8">
          ...
          <div className="flex flex-col items-center gap-6">
            <motion.div
              animate={agentState === "listening" ? { scale: [1, 1.05, 1] } : {}}
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <p className="text-sm font-medium text-white/60">
                  ...
                  {agentState === "listening" && <span className="text-primary">Listening...</span>}
                  {agentState === "thinking" && <span className="text-accent">Processing your request...</span>}
                  {agentState === "speaking" && <span className="text-emerald-400">Speaking...</span>}
                </p>
                {transcript && (
                  <motion.p
                    initial={{ opacity: 0 }}
